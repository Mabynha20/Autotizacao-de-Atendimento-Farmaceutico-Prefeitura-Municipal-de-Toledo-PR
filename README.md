...
O objetivo é automatizar o processo de atendimento farmacêutico, tornando a coleta de informações, a tomada de decisão e a geração de recomendações mais rápidas, padronizadas e seguras.
O sistema permite:
...
3️-Habilitar Macros no Excel

Ao abrir o arquivo pela primeira vez, o Excel provavelmente exibirá um aviso de segurança.
Siga os passos:
-Abra o arquivo .xlsm
...
✅ Habilitar todas as macros (não recomendado — apenas para testes locais)
ou
...
Este sistema é um protótipo acadêmico e deve ser utilizado apenas para fins educacionais ou de demonstração. Não substitui julgamento clínico profissional.
